  ...
  <ul>
    ...
    <li class="<?php echo ($key%2) ? "odd" : "even"; if(count($items)==$key+1) echo ' lastItem'; ?>">
      ...
      <div class="moduleItemIntrotext media">
	      ...
	      <a class="moduleItemImage pull-left" href="<?php echo $item->link; ?>" title="<?php echo JText::_('K2_CONTINUE_READING'); ?> &quot;<?php echo K2HelperUtilities::cleanHtml($item->title); ?>&quot;">
		...
		<div class="media-body"> 
			...
			<?php if($params->get('itemDateCreated')): ?>
			  <span class="moduleItemDateCreated">
				...
				<?php echo JHTML::_('date', $item->created, JText::_('VINA_K2_DATE_2')); ?></span>
			<?php endif; ?>
		</div>
      ...
      <?php endif; ?>
			...
			<a class="moduleItemReadMore pull-right" href="<?php echo $item->link; ?>">

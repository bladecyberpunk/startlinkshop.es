...
<div id="k2ModuleBox<?php echo $module->id; ?>" class="k2ItemsBlock<?php if($params->get('moduleclass_sfx')) echo ' '.$params->get('moduleclass_sfx'); ?>">
	...
	<?php $i=0; ?>
		...
		$lastContainer='span';
		if((count($items)) < 5)
			$span2 .= ( 12 / (count($items)));
		else
			$span2 .= 4;
		?>
    <?php foreach ($items as $key=>$item):	?>
    <li class="<?php echo $lastContainer . $span2; ?> <?php echo ($key%2) ? "odd" : "even"; if(count($items)==$key+1) echo ' lastItem'; ?>">
		<?php $i++; ?>
				...
				<?php endif; ?>
				 ...
				 <?php if($params->get('itemDateCreated')): ?>
				  <span class="moduleItemDateCreated">
					...
					<?php echo JHTML::_('date', $item->created, JText::_('K2_DATE_FORMAT_LC')); ?></span>
				  <?php endif; ?>

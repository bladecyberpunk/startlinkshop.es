		...
		<?php foreach ($this->items as $i => $article) : ?>
			...
			<?php endif; ?>
				<?php if (in_array($article->access, $this->user->getAuthorisedViewLevels())) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('show_create_date', 1)) : ?>
						<div class="blog-date">
							<span class="sp_date_day"><?php echo (JText::sprintf(JHtml::_('date',$article->created, "d"))); ?></span>
							<span class="sp_date_month"><?php echo substr((JText::sprintf(JHtml::_('date',$this->item->created, "F"))),0,3); ?> &nbsp; <?php echo (JText::sprintf(JHtml::_('date',$this->item->created, "Y"))); ?></span>
						</div>
					<?php endif; ?>

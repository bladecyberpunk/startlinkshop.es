...
<div class="catItemView group<?php echo ucfirst($this->item->itemGroup); ?><?php echo ($this->item->featured) ? ' catItemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
  ...
  <div class="catItemBody media">
	<div class="row-fluid blog-wrap">
	  ...
	  <!-- Item Image -->
	  <div class="catItemImageBlock span5">
		  <span class="catItemImage">
			...
			<div class="blogdate">
				...
				<span class="itemDateCreated pull-left">
					...
					<?php echo substr(JHTML::_('date', $this->item->created , JText::_('VINA_K2_M')),0,3); ?> <?php echo JHTML::_('date', $this->item->created , JText::_('VINA_K2_Y')); ?>	
					</span>
				</span>
			</div>
			<?php endif; ?>
		...
		<ul class="vina-header-toolbar">
	  	...
	  	<!-- Item introtext -->
	  	<div class="catItemIntroText span7">
			...
			<div class="catItemReadmore">
				<a class="vina-readmore" href="<?php echo $this->item->link; ?>">
	...
	<?php if($this->item->params->get('catItemTags') && count($this->item->tags)): ?>
	  	<!-- Item tags -->
	  	<div class="catItemTagsBlock TagsBlock">

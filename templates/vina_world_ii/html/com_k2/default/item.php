	...
	<div class="blogdate">
		<?php if($this->item->params->get('itemDateCreated')): ?>	
			...
			<span class="itemDateCreated pull-left">
				...
				<?php echo JHTML::_('date', $this->item->created , JText::_('VINA_K2_D')); ?>
				</span>
				<span class="sp_date_month">
				<?php echo JHTML::_('date', $this->item->created , JText::_('VINA_K2_M')); ?> <?php echo JHTML::_('date', $this->item->created , JText::_('VINA_K2_Y')); ?>	
				</span>
			</span>
		<?php endif; ?>
	</div>
...
<div class="itemContent">
  <div class="itemBody media">
	  ...
	  <div class="itemImageBlock pull-left">
		  <span class="itemImage">
		  	<a class="no-modal modal" rel="{handler: 'image'}" href="<?php echo $this->item->imageXLarge; ?>" title="<?php echo JText::_('K2_CLICK_TO_PREVIEW_IMAGE'); ?>">
  ...
  <!-- Latest items from author -->
	<div class="itemAuthorLatest vina-item-last">
		<h3><?php echo JText::_('K2_LATEST_FROM'); ?> <?php echo $this->item->author->name; ?></h3>
		<ul>
			<?php foreach($this->authorLatestItems as $key=>$item): ?>
			<li class="<?php echo ($key%2) ? "odd" : "even"; ?> icon-check-sign icon-color">
 ...
 <?php if($this->item->params->get('itemComments') && ($this->item->params->get('comments') == '1' || ($this->item->params->get('comments') == '2')) && empty($this->item->event->K2CommentsBlock)): ?>
	  ...
	  <ul class="itemCommentsList">
	    ...
	    <li class="<?php echo ($key%2) ? "odd" : "even"; echo (!$this->item->created_by_alias && $comment->userID==$this->item->created_by) ? " authorResponse" : ""; echo($comment->published) ? '':' unpublishedComment'; ?>">
			...
			<div class="comment-user pull-left">
					<?php if($comment->userImage && !$pos): ?>
						  <img class="pull-left" src="<?php echo $comment->userImage; ?>" alt="<?php echo JFilterOutput::cleanText($comment->userName); ?>" width="<?php echo $this->item->params->get('commenterImgWidth'); ?>" />		  
					<?php endif; ?>
									
					<span class="commentDate">
					<?php echo JHTML::_('date', $comment->commentDate, JText::_('K2_DATE_FORMAT')); ?>
				</span>
		    	...
		    	<a class="vina-readmore" href="<?php echo $this->item->link; ?>#comment<?php echo $comment->id; ?>" name="comment<?php echo $comment->id; ?>" id="comment<?php echo $comment->id; ?>">
  ...
  <?php endif; ?>
	...
	<div class="itemBackToTop pull-right">
		<a class="k2Anchor icon-circle-arrow-up icon-color" href="<?php echo $this->item->link; ?>#startOfPageId<?php echo JRequest::getInt('id'); ?>">
			<span class="hidden"><?php echo JText::_('K2_BACK_TO_TOP'); ?></span>
		</a>
	</div>
	<?php endif; ?>

<?php
	...
	$modChromes = array('sp_bcolor','sp_color','sp_xhtml', 'sp_flat', 'sp_border', 'sp_raw', 'sp_menu', 'none'  );

	function modChrome_sp_bcolor($module, $params, $attribs)
	{ ?>
			...
			<?php if ($module->showtitle != 0) { ?>
				<div class="world-title-bg">
					<h2 class="world-title">		
						<span>
						<?php 
							$title= str_replace(array('{','}'), array('<span class="color">','</span>'), $module->title);
							echo $title;
						?>
						<span>
					</h2>
	...
	function modChrome_sp_color($module, $params, $attribs)
	{ ?>
	<div class="module <?php echo $params->get('moduleclass_sfx'); ?>">	
		<div class="mod-wrapper-flat clearfix">		
			<?php if ($module->showtitle != 0) { ?>
		...
		<div class="mod-wrapper-flat clearfix">		
			<?php if ($module->showtitle != 0) { ?>
				<h3 class="header border">			
					<?php 
						echo '<span>'.$module->title.'</span>';
						echo '<span class="title-border"></span>';
						echo '<span class="title-border-content"></span>';
					?>
				</h3>
				<?php
					$modsfx=$params->get('moduleclass_sfx');
